...
import {  useBlockandunblockMutation, useFetchUsersMutation } from "@/services/apis/AuthApis";
  ...
  return (
    <div className="w-full h-full ">
      ...
      <div className="w-full  bg-slate-00 flex justify-end h-10 relative">
        <input type="text"  placeholder="Search..."  className="mr-[1rem] rounded-md border-2  text-sm h-full w-3/12 pl-3 dark:bg-zinc-900 focus:outline-none"/>
