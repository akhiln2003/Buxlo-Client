  ...
  return (
    <div className="w-full ">
      <div
        ...
        className="w-full h-screen -mt-16 bg-cover bg-center bg-no-repeat flex items-center justify-center relative bg-white/80 dark:bg-black/90 bg-blend-color-dodge"
      >
        <div className="text-center text-black  dark:text-white px-4 z-10">
          <h1 className="text-5xl font-sans font-extrabold mb-4 drop-shadow-md ">Built to power the world  of digital finance </h1>
