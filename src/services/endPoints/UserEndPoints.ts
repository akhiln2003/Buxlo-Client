export enum UserApiEndPoints {
  ...
  fetchSlots = "/booking/user/fetchslots",
  sendFeedback = "/user/user/sendfeedback",
  likeAndDislike = "/user/user/dislikeandlike",
  lockSlot = "/booking/user/lockSlot",
  fetchPaymentHistorySummary = "/payment/user/fetchpaymethistorysummary",
}
