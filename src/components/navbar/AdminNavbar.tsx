...
function AdminNavbar() {
  ...
  const sidebarLinks = [
    ...
    {
      name: "Users",
      url: AdminUrls.userManagement,
      icon: <Users size={20} />,
    },
    {
      name: "Mentors",
      url: AdminUrls.mentorManagement,
      icon: <BriefcaseBusiness size={20} />,
    },
    {
      name: "ADV",
      url: AdminUrls.advManagement,
      icon: <Megaphone size={20} />,
    },
    {
      name: "KYC",
      url: AdminUrls.verifyprofile,
      icon: <Dock size={20} />,
    },
  ];
            ...
            {isOpen && (
              ...
              >
                <div className="px-2 pt-4 pb-6 space-y-1">
                  ...
                  {user?.role === USER_ROLE.ADMIN && (
                    <div className="bg-gray-50 dark:bg-zinc-800/50 p-4 rounded-lg mb-4">
                      <div className="flex items-center space-x-3">
                        {user?.avatar ? (
                          <img
                            src={user?.avatar}
